...
const chatToolKeys = computed(() => aiConfig.value.toolDefaults?.chat ?? [])
...
const modelOptions = computed(() => aiConfig.value.modelOptions ?? [])
        ...
        <div class="header-inner">
          <div class="left">
            ...
            <div class="model-select">
              ...
              >
                <a-select-option v-for="model in modelOptions" :key="model.key" :value="model.key">
